...
class WaitForPartnerPage(WaitPage):
    ...
    def after_all_players_arrive(self):
        # Generated here, because we don't have the group object before
        # get_players_for_group has created a group
        for group in self.group.in_rounds(1, Constants.num_rounds):
            ...
            # in order to increase the probability for players to get critical times,
            # we could use numpy instead and change the probabilities of the picks, see
